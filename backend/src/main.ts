...
async function bootstrap() {
  var whitelist = [
    'http://localhost:8080',
    'http://localhost:3000',
    'https://laboratory.life:3000',
    'https://laboratory.life:8080',
    'http://laboratory.life:8080',
    'http://laboratory.life:3000',
    'https://laboratory.life',
    'http://localhost',
  ];
  const httpsOptions = {
  ...
  const config1 = new DocumentBuilder()
    .setTitle('LABORATORY APIsss')
    .setDescription('laboratory backend')
    .setVersion('1.0')
    .addBearerAuth({
      type: 'http',
      scheme: 'bearer',
